   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      if (!!phoneNumber) {
         ...
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            console.log(chalk.bgBlack(chalk.redBright("Start with country code of your WhatsApp Number, Example : +263713431767")))
            process.exit(0)
         }
      } else {
         phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFor example: +263713431767: `)))
         phoneNumber = phoneNumber.replace(/[^0-9]/g, '')
...
//------------------------------------------------------
    XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            await delay(1000 * 10)
            await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `🪀Support/Contact Developer\n\n\n⎆Donate: https://qu.ax/BdMwr.jpg\n\n⎆YouTube: https://youtube.com/@OGNeon\n\n⎆Telegram Channel: https://t.me/xeonbotinc\n\n⎆Telegram Chat: https://t.me/+AYOyJflnt-AzNGFl\n\n⎆WhatsApp Gc1: https://whatsapp.com/channel/0029Vb0mA2i3QxS2C1kvFp3p\n\n⎆WhatsApp Gc2: https://whatsapp.com/channel/0029Vb0mA2i3QxS2C1kvFp3p\n\n⎆WhatsApp Gc3: https://whatsapp.com/channel/0029Vb0mA2i3QxS2C1kvFp3p\n\n⎆WhatsApp Pm: Wa.me/263713431767\n\n⎆Instagram: https://instagram.com/unicorn_xeon13\n\n⎆GitHub: https://github.com/N3onAbyss/\n\n⎆Blog: https://dreamguyxeonfiles.blogspot.com/2022/05/bots%20whatsapp%20mods.html?m=1\n\n\n` });
...
│ Ohayo 😽
└┬❖  
┌┤✑  Thanks for using N-PairCode
│└────────────┈ ⳹        
│©2020-2023 NeonBotsInc 
└─────────────────┈ ⳹\n\n ` }, {quoted: xeonses});
              await delay(1000 * 2) 
              process.exit(0)
        }
